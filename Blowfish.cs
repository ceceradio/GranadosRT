...
namespace GranadosRT.Routrek.Crypto {
	...
	public sealed class Blowfish {
        ...
        public void blockEncrypt([ReadOnlyArray()] byte[] input, int inOffset, [WriteOnlyArray()] byte[] output, int outOffset)
        {
			uint L, R;
        ...
        public void encryptSSH1Style([ReadOnlyArray()] byte[] src, int srcOff, int len, [WriteOnlyArray()] byte[] dest, int destOff)
        {
			int end = srcOff + len;
			int i, j;
        ...
        public void decryptSSH1Style([ReadOnlyArray()] byte[] src, int srcOff, int len, [WriteOnlyArray()] byte[] dest, int destOff)
        {
			int    end = srcOff + len;
			int    i, j;
