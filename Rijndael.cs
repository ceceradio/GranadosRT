...
namespace GranadosRT.Routrek.Crypto
{
	public sealed class Rijndael
	{
		...
		// set _IV
		///////////////////////////////////////////////
        public void SetIV([ReadOnlyArray()] byte[] newiv)
        {
        ...
        public void decryptCBC([ReadOnlyArray()] byte[] input, int inputOffset, int inputLen, [WriteOnlyArray()] byte[] output, int outputOffset)
        {
			int block_size = GetBlockSize();
        ...
        public void decryptCTR([ReadOnlyArray()]byte[] input, int inputOffset, int inputLen, [WriteOnlyArray()] byte[] output, int outputOffset)
        {
        ...
        public void blockEncrypt([ReadOnlyArray()] byte[] src, int inOffset, [WriteOnlyArray()] byte[] dst, int outOffset)
        {
			int[] Ker  = _Ke[0];
        ...
        public void blockDecrypt([ReadOnlyArray()] byte[] src, int inOffset, [WriteOnlyArray()] byte[] dst, int outOffset)
        {
			int[] Kdr = _Kd[0];
