...
namespace GranadosRT.Routrek.Toolkit {
	...
	public sealed class Base64 {
        ...
        public static byte[] Encode([ReadOnlyArray()] byte[] data)
        {
			return Encode(data, 0, data.Length);
		}

        public static byte[] Decode([ReadOnlyArray()] byte[] data)
        {
			return Decode(data, 0, data.Length);
		}

        public static byte[] Decode([ReadOnlyArray()] byte[] encoded, int offset, int length)
        {
			int j, c, v;
			int bits = 0;
        ...
        public static byte[] Encode([ReadOnlyArray()] byte[] data, int offset, int length)
        {
			byte[] encoded;
			int x1, x2, x3, x4;
			int i, j, r, n;
