...
namespace GranadosRT.Routrek.SSHC {
	...
	*/		
	...
	public class SSHException : Exception {
		...
		public SSHException(string msg, [ReadOnlyArray()] byte[] data) : base(msg) {
			_data = data;
		}
	...
	public sealed class Strings {
		...
		public static void Reload() {
            ...
            Assembly assembly = typeof(Strings).GetTypeInfo().Assembly;
            _strings = new StringResources("strings", assembly);
		}
	}
